...
const defaultPortfolio = {
  profile: {
    ...
    role: 'Data Scientist | Data Analyst | Python Developer',
    tagline: 'Data-driven professional focused on machine learning, business intelligence, and practical analytics solutions.',
  ...
  experience: [
    {
      ...
      details: 'Performed end-to-end data workflow: Collect, Clean, Prepare, Process, Analyze, and Share data to drive informed business decisions. Gained hands-on experience in data preparation, transformation, and analytics using industry-standard tools.'
    },
    {
      period: 'Jun 2025 - Sep 2025',
      title: 'Data Analyst',
      company: 'HCL GUVI (Remote)',
      details: 'Analyzed business data using advanced analytics techniques and Microsoft Power BI to create actionable insights. Developed dashboards and reports that enhanced data-driven decision-making processes.'
    },
    {
      period: 'Mar 2025 - Apr 2025',
      title: 'Web Developer Intern',
      company: 'Edunet Foundation',
      details: 'Developed full-stack web applications using MERN stack (MongoDB, Express, React, Node.js). Built scalable solutions addressing real-world problems with focus on clean architecture, responsive design, and performance optimization.'
    }
  ],
  education: [
    {
  ...
  projects: [
    {
      title: 'UniPulse AI',
      description: 'A campus intelligence dashboard that analyzes student sentiment, placement trends, festival participation, extracurricular engagement, hostel life, and overall university experience through AI-driven analytics.',
    ...
    },
    {
      ...
      description: 'A recommendation engine designed to improve product discovery and customer engagement using behavioral patterns and personalized suggestions. It mirrors the shopping experience of Amazon and Flipkart with curated product discovery.',
      ...
      <footer id="contact" className="footer">
        ...
        <div className="social-bar container">
          <a href={profile.linkedin} target="_blank" rel="noreferrer" aria-label="LinkedIn">
            <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6.94 8.5A1.56 1.56 0 1 1 6.94 5.4a1.56 1.56 0 0 1 0 3.1ZM5.5 9.8h2.88v9.7H5.5V9.8Zm4.78 0h2.75v1.33h.04c.38-.72 1.32-1.48 2.72-1.48 2.9 0 3.43 1.9 3.43 4.38v6.47h-2.88v-6.06c0-1.44-.03-3.3-2.01-3.3-2.02 0-2.33 1.57-2.33 3.2v6.16H10.3V9.8Z" fill="currentColor"/></svg>
          </a>
          <a href={profile.twitter} target="_blank" rel="noreferrer" aria-label="Twitter">
            <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M18.9 2h3.66l-7.99 9.13L23.5 22h-7.2l-5.64-8.15L4.04 22H.37l8.55-9.76L.5 2h7.38l5.1 7.46L18.9 2Zm-1.28 18h2.01L7.1 3.9H4.98L17.62 20Z" fill="currentColor"/></svg>
          </a>
          <a href={profile.instagram} target="_blank" rel="noreferrer" aria-label="Instagram">
            <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7 2h10a5 5 0 0 1 5 5v10a5 5 0 0 1-5 5H7a5 5 0 0 1-5-5V7a5 5 0 0 1 5-5Zm0 2a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3H7Zm5 3.2A4.8 4.8 0 1 1 7.2 12 4.8 4.8 0 0 1 12 7.2Zm0 2.1A2.7 2.7 0 1 0 14.7 12 2.7 2.7 0 0 0 12 9.3Zm5.13-3.4a1.13 1.13 0 1 1-1.13 1.13 1.13 1.13 0 0 1 1.13-1.13Z" fill="currentColor"/></svg>
          </a>
          <a href={profile.github} target="_blank" rel="noreferrer" aria-label="GitHub">
            <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 .5A12 12 0 0 0 8.2 23.4c.6.1.8-.3.8-.7v-2.5c-3.4.7-4.1-1.5-4.1-1.5-.6-1.4-1.3-1.8-1.3-1.8-1.1-.8.1-.8.1-.8 1.2.1 1.9 1.3 1.9 1.3 1.1 1.9 2.8 1.4 3.5 1.1.1-.8.4-1.4.7-1.7-2.7-.3-5.5-1.3-5.5-5.9 0-1.3.5-2.4 1.3-3.2-.1-.3-.6-1.6.1-3.2 0 0 1.1-.4 3.4 1.2a11.5 11.5 0 0 1 6.2 0c2.3-1.6 3.4-1.2 3.4-1.2.7 1.6.2 2.9.1 3.2.8.8 1.3 1.9 1.3 3.2 0 4.6-2.8 5.6-5.5 5.9.4.4.8 1.1.8 2.2v3.2c0 .4.2.8.8.7A12 12 0 0 0 12 .5Z" fill="currentColor"/></svg>
          </a>
        </div>
